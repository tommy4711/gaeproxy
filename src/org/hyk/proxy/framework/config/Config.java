 ...
 *
 * @author yinqiwen [ 2011-7-5 | ����09:03:26 ]
 *
 */
...
public class Config {
	...
	public void init(SimpleSocketAddress local, String appids)
			throws Exception {
		// General part
		localProxyServerAddress = local;
		threadPoolSize = 5;

		// Google AppEngine part
		client2ServerConnectionMode = ConnectionMode.fromString("HTTP");
