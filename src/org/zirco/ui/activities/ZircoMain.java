 ...
 */
public class ZircoMain extends Activity implements IToolbarsContainer,
				...
				.setOnQuickActionClickListener(new OnQuickActionClickListener() {
					...
					public void onQuickActionClicked(QuickActionWidget widget,
						...
						case 0:
							...
							break;
						case 1:
							ApplicationUtils.sharePage(ZircoMain.this,
	...
	private void initializeCurrentWebView() {
		...
		mCurrentWebView.setWebChromeClient(new WebChromeClient() {
			...
			public void openFileChooser(ValueCallback<Uri> uploadMsg) {
				...
				i.setType("*/*");
				ZircoMain.this.startActivityForResult(Intent.createChooser(i,
						ZircoMain.this
			...
			public boolean onJsPrompt(WebView view, String url, String message,
				...
				final LayoutInflater factory = LayoutInflater
						.from(ZircoMain.this);
				final View v = factory.inflate(R.layout.javascriptpromptdialog,
						null);
	...
	public void onPageFinished(String url) {
		...
		// no ad sweep
		// if
		// ((Controller.getInstance().getPreferences().getBoolean(Constants.PREFERENCES_ADBLOCKER_ENABLE,
		// true)) &&
